...
from keras.layers import Convolution2D, AveragePooling2D, Convolution3D, AveragePooling3D
...
model_name	= "sabado_average_pooling"
...
model_x.add(AveragePooling2D(pool_size=pool_size_2d))
...
model_y.add(AveragePooling2D(pool_size=pool_size_2d))
...
model_z.add(AveragePooling2D(pool_size=pool_size_2d))
